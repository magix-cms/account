...
{block name="main"}
    <main id="content">
        ...
        <article id="article" class="container">
            <h1 class="h3">{#login_root_h1#}</h1>
            {block name="article:content"}
            <div class="row row-center">
                <div id="login-box" class="col-12 col-sm-6 col-lg-4">
                    <div class="content-box">
                        {include file="account/form/login.tpl" formclass="validate_form nice-form refresh_form"}
                        <div class="row">
                            <p class="col-12 col-sm-6"><a class="tosignin" data-toggle="collapse" href="#user-panel" title="{#create_btn#}">{#create_btn#}</a></p>
